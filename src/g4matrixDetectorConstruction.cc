...
G4VPhysicalVolume* g4matrixDetectorConstruction::Construct()
{
  ...
  {
    // Teflon box
    G4Box* extBox = new G4Box("extBox",fTeflonExt_x/2.0,fTeflonExt_y/2.0,fTeflonExt_z/2.0);
    G4Box* intBox = new G4Box("intBox",fTeflonInt_x/2.0,fTeflonInt_y/2.0,fTeflonInt_z/2.0);
    ...
    G4SubtractionSolid* teflonBox = new G4SubtractionSolid("TeflonBox", extBox, intBox,0, zTransBox);
    ...
    G4PVPlacement* teflonPhy = new G4PVPlacement(0,                                    // rotation wrt mother volume
                                                 ...
                                                 "TeflonPhy",                          // name
                                                 expHall_log,                          // associated mother log volume
    ...
    G4LogicalBorderSurface* temp_logical_border = new G4LogicalBorderSurface("TeflonSurfaceLogicalB",
                                                                             expHall_phys,
                                                                             teflonPhy,
                                                                             teflonSurface);
  }
  ...
  if(fGreaseFrontCryToGlass_z != 0)
  {
    ...
    G4Box* greaseFrontCryToGlass_box = new G4Box("GreaseFrontCryToGlass",fMPPCArray_x/2.0,fMPPCArray_y/2.0,fGreaseFrontCryToGlass_z/2.0);
    ...
    G4VPhysicalVolume* greaseFrontCryToGlass_phys = new G4PVPlacement(0,G4ThreeVector(pGreaseFrontCryToGlass_x,pGreaseFrontCryToGlass_y,pGreaseFrontCryToGlass_z),greaseFrontCryToGlass_log,"GreaseFrontCryToGlass",expHall_log,false,0,fCheckOverlaps);
  ...
  {
    //glass front
    G4Box* glassFront_box = new G4Box("GlassFront",fMPPCArray_x/2.0,fMPPCArray_y/2.0,fGlassFront_z/2.0);
    G4LogicalVolume* glassFront_log = new G4LogicalVolume(glassFront_box,Fused_silica,"GlassFront",0,0,0);
    G4VPhysicalVolume* glassFront_phys = new G4PVPlacement(0,G4ThreeVector(pGlassFront_x,pGlassFront_y,pGlassFront_z),glassFront_log,"GlassFront",expHall_log,false,0,fCheckOverlaps);
  ...
  if(fGreaseFrontGlassToMPPC_z != 0)
  {
    ...
    G4Box* greaseFrontGlassToMPPC_box = new G4Box("GreaseFrontGlassToMPPC",fMPPCArray_x/2.0,fMPPCArray_y/2.0,fGreaseFrontGlassToMPPC_z/2.0);
    ...
    G4VPhysicalVolume* greaseFrontGlassToMPPC_phys = new G4PVPlacement(0,G4ThreeVector(pGreaseFrontGlassToMPPC_x,pGreaseFrontGlassToMPPC_y,pGreaseFrontGlassToMPPC_z),greaseFrontGlassToMPPC_log,"GreaseFrontGlassToMPPC",expHall_log,false,0,fCheckOverlaps);
  ...
  {
    G4Box* greaseFrontGlassToMPPC_box = new G4Box("AirGapCrystalMPPC",fMPPCArray_x/2.0,fMPPCArray_y/2.0,0.01/2.0);
    ...
    G4VPhysicalVolume* greaseFrontGlassToMPPC_phys = new G4PVPlacement(0,G4ThreeVector(pGreaseFrontGlassToMPPC_x,pGreaseFrontGlassToMPPC_y,pGreaseFrontGlassToMPPC_z),greaseFrontGlassToMPPC_log,"AirGapCrystalMPPC",expHall_log,false,0,fCheckOverlaps);
    G4VisAttributes* GreaseFrontGlassToMPPCVisulizationAttribute = new G4VisAttributes(G4Colour(0.0,0.0,1.0)); //blue
    greaseFrontGlassToMPPC_log->SetVisAttributes(GreaseFrontGlassToMPPCVisulizationAttribute); // we also set here the visualization colors
    if(!volumeInFrontIsSet)
    {
  ...
  {
    //epoxy layer
    G4Box* epoxy_box = new G4Box("Epoxy",fMPPCArray_x/2.0,fMPPCArray_y/2.0,fEpoxy_z/2.0);
    G4LogicalVolume* epoxy_log = new G4LogicalVolume(epoxy_box,Epoxy,"Epoxy",0,0,0);
    G4VPhysicalVolume* epoxy_phys = new G4PVPlacement(0,G4ThreeVector(pEpoxy_x,pEpoxy_y,pEpoxy_z),epoxy_log,"Epoxy",expHall_log,false,0,fCheckOverlaps);
  ...
  G4VPhysicalVolume* MPPCArray_phys = new G4PVPlacement(0,G4ThreeVector(pMPPCArray_x,pMPPCArray_y,pMPPCArray_z),MPPCArray_log,"MPPCArray",expHall_log,false,0,fCheckOverlaps);
  ...
  if(fGreaseBackCryToGlass_z != 0)
  {
    ...
    G4Box* greaseBackCryToGlass_box = new G4Box("GreaseBackCryToGlass",fMPPCArray_x/2.0,fMPPCArray_y/2.0,fGreaseBackCryToGlass_z/2.0);
    ...
    G4VPhysicalVolume* greaseBackCryToGlass_phys = new G4PVPlacement(0,G4ThreeVector(pGreaseBackCryToGlass_x,pGreaseBackCryToGlass_y,pGreaseBackCryToGlass_z),greaseBackCryToGlass_log,"GreaseBackCryToGlass",expHall_log,false,0,fCheckOverlaps);
  ...
  {
    //glass back
    G4Box* glassBack_box = new G4Box("GlassBack",fMPPCArray_x/2.0,fMPPCArray_y/2.0,fGlassBack_z/2.0);
    ...
    G4VPhysicalVolume* glassBack_phys = new G4PVPlacement(0,G4ThreeVector(pGlassBack_x,pGlassBack_y,pGlassBack_z),glassBack_log,"GlassBack",expHall_log,false,0,fCheckOverlaps);
  ...
  G4Box* airBack_box = new G4Box("AirBack",fMPPCArray_x/2.0,fMPPCArray_y/2.0,fAirBack_z/2.0);
  G4LogicalVolume* airBack_log = new G4LogicalVolume(airBack_box,airThinLayer,"AirBack",0,0,0);
  G4VPhysicalVolume* airBack_phys = new G4PVPlacement(0,G4ThreeVector(pAirBack_x,pAirBack_y,pAirBack_z),airBack_log,"AirBack",expHall_log,false,0,fCheckOverlaps);
  ...
  G4Box* fakeAirBack_box = new G4Box("BackEsrReflector",fMPPCArray_x/2.0,fMPPCArray_y/2.0,fFakeAirBack_z/2.0);
  G4LogicalVolume* fakeAirBack_log = new G4LogicalVolume(fakeAirBack_box,airThinLayer,"BackEsrReflector",0,0,0);
  G4VPhysicalVolume* fakeAirBack_phys = new G4PVPlacement(0,G4ThreeVector(pFakeAirBack_x,pFakeAirBack_y,pFakeAirBack_z),fakeAirBack_log,"BackEsrReflector",expHall_log,false,0,fCheckOverlaps);
  ...
  // define a crystal as two layers of materials
  // LYSO and Plastic
  ...
  //       Surfname << "Cry_to_Lat_" << iCry << "_" << iLat;
  ...
  //       //front
  //       name.str("");
  //       name << "EsrFronSurface_" << iCry << "_" << iLat ;
  ...
  //       //back
  //       name.str("");
  //       name << "EsrBackSurface_" << iCry << "_" << iLat ;
  ...
  //     //front
  //     name.str("");
  //     name << "CrystalFrontRealSurface_" << iCry ;
  ...
  //     //back
  //     name.str("");
  //     name << "CrystalBackRealSurface_"<< iCry ;
